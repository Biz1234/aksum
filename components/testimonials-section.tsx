...
const testimonials = [
  {
    ...
    content: "Degan Technologies PLC delivers excellence with every project. Their ability to integrate innovative technology with a deep understanding of our industry needs has made them an invaluable asset. Their modern, efficient approach ensures we're always ahead of the curve in a competitive market.",
    rating: 5,
    company: "Degan Technologies",
  },
  {
    name: "Dr. Abebe Teshome",
    role: "IT Director",
    content: "Aksum Tech delivered an exceptional university management system that transformed how we handle student administration. Their team was professional and responsive throughout the project.",
    rating: 5,
  ...
  },
  {
    name: "Sara Hailu",
    role: "CEO",
    content: "Working with Aksum Tech was a game-changer for our business. They built a robust financial platform that exceeded our expectations in both performance and security.",
    rating: 5,
    company: "Addis Finance",
  },
  {
    name: "Yohannes Bekele",
    role: "Operations Manager",
    content: "The logistics platform developed by Aksum Tech has streamlined our operations significantly. Their understanding of our business needs was impressive.",
    rating: 4,
    company: "Ethio Logistics",
  },
  {
    name: "Tigist Alemayehu",
    role: "CTO",
    content: "Exceptional technical expertise and outstanding support. Aksum Tech helped us build a telemedicine platform that has improved healthcare access across the region.",
    rating: 5,
    company: "MedTech Ethiopia",
  },
  {
    name: "Dawit Mengistu",
    role: "Founder",
